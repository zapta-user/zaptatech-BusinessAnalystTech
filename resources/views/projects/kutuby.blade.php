...
>
  ...
  <div class="pro-main-state">
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
          <img width="480" height="380" src="./assets/kutubyprojectpage.svg" alt="kutuby" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="./assets/P_Detail4.webp" alt="qme" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
      </div>
        <div class="pro-st-txt">
  ...
  <div
    ...
    <div class="col-xl-6 col-md-5 col-sm-8 col-10 d-flex justify-content-center align-items-center">
      <img width="480" height="380" src="./assets/Kutuby Mockuppp.svg" alt="kutuby" class="img-fluid" />
    </div>
