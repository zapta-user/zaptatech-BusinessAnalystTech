...
@endphp
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('https://assets-global.website-files.com/63dcf9306bbe5b2e5fbb8677/646bbd7ef8c07bb115fda420_Selling_Image.svg')}}" alt="Image for project detail 2" class="img-fluid" style="cursor: pointer" />
      </div>
        <div class="pro-st-txt">
