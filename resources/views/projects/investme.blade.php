...
>
  <div class="container-fluid px-xl-5 px-0">
    ...
    >
      <ul class="navbar-nav ms-xl-auto m-lg-auto gap-xl-4 gap-lg-0 gap-2">
        ...
        <li class="nav-item">
          <a class="nav-link mx-2 link-color pb-2" href="{{route('frontend.aboutUs')}}"
            >About Us</a
          >
        </li>
        <li class="nav-item">
          <a class="nav-link mx-2 link-color pb-2" href="{{route('frontend.services')}}"
            >Services</a
          >
        </li>
        <li class="nav-item">
          <a class="nav-link mx-2 link-color pb-2" href="{{route('frontend.blogs')}}"
            >Blogs</a
          >
        </li>
        <li class="nav-item">
          <a class="nav-link mx-2 link-color pb-2 active" href="{{route('frontend.projects')}}"
            >Projects</a
          >
        </li>
        <li class="nav-item">
          <a class="nav-link mx-2 link-color pb-2" href="{{route('frontend.partners')}}"
            >Partners</a
          >
        </li>
      </ul>
  ...
  <div
    ...
    <div class="d-flex gap-2 align-items-center justify-content-center">
      ...
      <a href="{{route('frontend.projects.investme')}}">
        <h4 class="text-orange text-center pt-md-0 pt-1">InvestMe</h4>
      </a>
    </div>
    <h1 class="text-white text-center fw-bold">InvestMe</h1>
    <p class="text-lg-start px-md-0" style="color: #dfdfdf">
        InvestMe unifies asset owners, investors, and accountants in a comprehensive investment platform. It facilitates transparent collaboration through features like reviews, contracts, and detailed financial reports.
    </p>
  </div>
    ...
    <div class="container">
      <div class="pr-st-main">
        <div class="pro-st-txt">
          ...
          <p>
            The investment landscape is full of challenges, including limited visibility into a diverse array of opportunities. Cumbersome management processes create inefficiencies, hindering the oversight and administration of portfolios. The absence of a centralized communication hub contributes to fragmented interactions among stakeholders. Moreover, the restricted access to expert financial guidance leaves investors and asset owners navigating financial decisions without optimal insights.
          </p>
        </div>
        <div>
            <img loading="lazy" width="591" height="400" src="{{asset('assets/InvestMe.webp')}}" alt="qme" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/P_Detail8.webp')}}" alt="qme" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
      </div>
        <div class="pro-st-txt">
          ...
          <div class="d-flex">
            ...
            <p class="hidden-text">
              Ensuring efficient and transparent communication among asset owners, investors, and accountants through features like reviews, contracts, and detailed financial reports
            </p>
        </div>
        <div class="d-flex">
          <img loading="lazy" width="25" height="25" src="{{asset('assets/iconamoon_arrow-up-2.svg')}}" alt="">
          <p class="hidden-text">Addressing challenges related to the scalability of the platform to handle diverse investment portfolios and a growing user base.</p>
      </div>
      <div class="d-flex">
        <img loading="lazy" width="25" height="25" src="{{asset('assets/iconamoon_arrow-up-2.svg')}}" alt="">
        <p class="hidden-text">Managing user-generated content such as reviews and ensuring it aligns with legal and ethical standards while maintaining a transparent collaboration environment.</p>
    </div>
  ...
  <div class="container">
    ...
    <div class="col-xl-6 col-md-5 col-sm-8 col-10 d-flex justify-content-center align-items-center">
      <img width="480" height="380" src="{{asset('assets/InvestME Mockup.svg')}}" alt="kutuby" class="img-fluid" />
    </div>
    <div class="col-md-5 d-flex flex-column gap-3 justify-content-center">
      ...
      <p class="brown pe-3 text-md-start text-center">
        InvestMe offers solutions by providing diverse investment opportunities, centralizing portfolio management, connecting users with expert accountants, ensuring transparent communication, and incorporating reporting tools. The platform aims to revolutionize the investment experience by mitigating challenges. Additionally, the platform prioritizes scalability, ensuring robust handling of diverse investment portfolios and a growing user base, fostering an adaptable investment environment. 
      </p>
    </div>
  </div>
  </div>
  ...
  <div class="projectcomponentsection row row-gap-3"
    ...
    <div
      ...
      <h2 class="text-orange text-center text-nowrap font-17">FinTech</h2>
    </div>
    <div
      class="col-lg-3">
    ...
    <div class="container">
      ...
      <div class="key-fec-main">
        <div class="key-fec-txt">
          ...
          <p>
            InvestMe provides users with a varied selection of investment options across different sectors and industries. This diversity ensures that users can explore and select assets that align with their specific financial goals and preferences, fostering a well-rounded and personalized investment experience.
          </p>
  ...
  <div class="container">
    <div class="key-fec-main">
      ...
      <div class="key-fec-txt">
        ...
        <p>
          The centralized portfolio management feature of InvestMe allows users, including both asset owners and investors, to efficiently oversee, track, and manage their entire investment portfolio within a unified interface. This centralized system enhances user convenience by consolidating all relevant information and actions in one accessible location.
        </p>
    ...
    <div class="container">
      <div class="key-fec-main">
        <div class="key-fec-txt">
          ...
          <p>
            InvestMe goes beyond simple connections by actively engaging users with seasoned accountants who serve as valuable sources of financial expertise and advice. This feature empowers investors and asset owners with professional insights, enabling them to make well-informed financial decisions based on the guidance of experienced financial professionals.
          </p>
