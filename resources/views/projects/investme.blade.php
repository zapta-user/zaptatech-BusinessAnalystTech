...
@endphp
  ...
  <div class="pro-main-state" style="align-items: center;"> 
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
            <img loading="lazy" width="591" height="400" src="{{asset('assets/invest-me-a-project-by-sync4tech-portfolio-mockup.webp')}}" alt="Invest Me a Project by Sync4Tech portfolio mockup" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/image-for-project-detail-1.webp')}}" alt="Image for project detail 1" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
      </div>
        <div class="pro-st-txt">
  ...
  <div class="container">
    ...
    <div class="col-xl-6 col-md-5 col-sm-8 col-10 d-flex justify-content-center align-items-center">
      <img width="480" height="380" src="{{asset('assets/invest-me-a-project-by-sync4tech-portfolio-mockup-1.svg')}}" alt="Invest Me a Project by Sync4Tech portfolio mockup 1" class="img-fluid" />
    </div>
