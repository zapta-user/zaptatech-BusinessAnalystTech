...
@endphp
  ...
  <div class="pro-main-state" style="align-items: center;"> 
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
            <img loading="lazy" width="591" height="400" src="{{asset('assets/qme-project-mobile-mockup.webp')}}" style="cursor: pointer" alt="QME project mobile mockup" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/image-for-project-detail-4.webp')}}" alt="Image for project detail 4" class="img-fluid" style="cursor: pointer" />
      </div>
        <div class="pro-st-txt">
