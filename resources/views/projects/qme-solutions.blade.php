...
>
  ...
  <div class="pro-main-state" style="align-items: center;"> 
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
            <img loading="lazy" width="591" height="400" src="./assets/Qme1Mockuppp.webp" alt="qme" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="./assets/P_Detail3.webp" alt="qme" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
      </div>
        <div class="pro-st-txt">
  ...
  <div class="container">
    ...
    <div class="col-xl-6 col-md-5 col-sm-8 col-10 d-flex justify-content-center align-items-center">
      <img src="./assets/Qme1Mockuppp.webp" alt="kutuby" class="img-fluid" />
    </div>
