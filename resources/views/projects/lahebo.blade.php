...
@endphp
  ...
  <div class="pro-main-state" style="align-items: center;"> 
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
            <img loading="lazy" width="480" height="380" src="{{asset('assets/lahebo-a-project-by-sync4tech-portfolio-mockup.webp')}}" alt="qme" class="img-fluid" style="cursor: pointer" alt="Lahebo a Project by Sync4Tech portfolio mockup" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/image-for-project-detail-3.webp')}}" alt="Image for project detail 3" class="img-fluid" style="cursor: pointer" alt="kutuby" class="img-fluid" />
      </div>
        <div class="pro-st-txt">
  ...
  <div class="container">
    ...
    <div class="col-xl-6 col-md-5 col-sm-8 col-10 d-flex justify-content-center align-items-center">
      <img width="480" height="380" src="{{asset('assets/lahebo-project-details-by-sync4tech-portfolio-logo.webp')}}" alt="Lahebo Project details by Sync4Tech portfolio logo" class="img-fluid" />
    </div>
