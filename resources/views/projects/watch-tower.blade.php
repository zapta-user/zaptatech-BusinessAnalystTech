...
@endphp
  ...
  <div class="pro-main-state" style="align-items: center;"> 
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
            <img loading="lazy" width="480" height="380" src="{{asset('assets/watchtower-sync4tech-portfolio-mockup-image.webp')}}" alt="qme" class="img-fluid" style="cursor: pointer" alt="WatchTower Sync4Tech portfolio mockup image" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/image-for-project-detail-9.webp')}}" alt="qme" class="img-fluid" style="cursor: pointer" alt="Image for project detail 9" class="img-fluid" />
      </div>
        <div class="pro-st-txt">
