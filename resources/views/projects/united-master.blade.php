  ...
  <div class="pro-main-state" style="align-items: center;"> 
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
            <img loading="lazy" width="480" height="380" src="{{asset('assets/united-masters-sync4tech-portfolio-banner-image.webp')}}" alt="United Masters Sync4tech Portfolio Banner Image" class="img-fluid" style="cursor: pointer" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="pr-st-main">
        ...
        border-radius: 10px; padding:5px">
          <img loading="lazy" width="591" height="400" src="{{asset('https://v.fastcdn.co/t/2676f833/0ab33d9a/1704778618-63449019-421x506x421x508x0x1-Artists-Select-V4.png')}}" alt="Image for project detail 8" style="cursor: pointer" />
      </div>
        <div class="pro-st-txt">
