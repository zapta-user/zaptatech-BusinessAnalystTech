    ...
    <div class="container">
      <div class="pr-st-main">
        ...
        border-radius: 10px; padding:5px">
          <img loading="lazy" width="591" height="400" src="{{asset('https://v.fastcdn.co/t/2676f833/0ab33d9a/1704778618-63449019-421x506x421x508x0x1-Artists-Select-V4.png')}}" alt="Image for project detail 8" class="" style="cursor: pointer" alt="kutuby" />
      </div>
        <div class="pro-st-txt">
