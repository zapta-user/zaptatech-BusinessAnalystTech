...
@endphp
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/image-for-project-detail-7.webp')}}" class="img-fluid" style="cursor: pointer" alt="Image for project detail 7" />
      </div>
        <div class="pro-st-txt">
