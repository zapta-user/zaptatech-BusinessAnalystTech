...
@endphp
  ...
  <div class="pro-main-state" style="align-items: center;">
    <div class="container">
      <div class="pr-st-main">
        ...
        <div>
          <img width="480" height="380" src="{{asset('assets/roomz-sync4tech-portfolio-banner-image-2.webp')}}" alt="Roomz Sync4Tech portfolio banner image 2" class="img-fluid" />
        </div>
      </div>
    </div>
  </div>
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/image-for-project-detail-7.webp')}}" alt="qme" class="img-fluid" style="cursor: pointer" alt="Image for project detail 7" class="img-fluid" />
      </div>
        <div class="pro-st-txt">
  ...
  <div class="cardsSection toolCardSection projectdetails d-flex row justify-content-center align-items-center gap-5"
    ...
    <div class="col-xl-6 col-md-5 col-sm-8 col-10 d-flex justify-content-center align-items-center">
      <img  width="480" height="380" src="{{asset('assets/roomz-sync4tech-portfolio-banner-image.webp')}}" alt="Roomz Sync4Tech portfolio banner image" class="img-fluid" />
    </div>
