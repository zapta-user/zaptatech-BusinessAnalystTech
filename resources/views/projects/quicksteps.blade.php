...
@endphp
  ...
  ;"> 
    <div class="container">
      <div class="pr-st-main">
        <div>
          <img loading="lazy" width="591" height="400" src="{{asset('assets/image-for-project-detail-5.webp')}}" alt="Image for project detail 5" class="img-fluid" style="cursor: pointer"/>
      </div>
        <div class="pro-st-txt">
