...
<section class="footer-section">
    <div class="container">
        ...
        <div class="d-flex flex-sm-row flex-column bottomFooter justify-content-between gap-sm-4 gap-2 pd-boot"
            ...
            <span class="smallTextFooter text-white pt-3 text-lg-center w-100 ps-lg-5 ms-lg-5" style="opacity: 0.6">©
                2022
                            ...
                            <form action="{{ route('frontend.contacts.store') }}"
                                ...
                                <div class="d-flex gap-3 flex-lg-row flex-column" style="width: 100% !important;">
                                    <div class="d-flex flex-column gap-2 w-100 pos-rev">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="email" id="contactemail2"
                ...
                <div class="row justify-content-center w-100 secondDiv" id="div3"
                    ...
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="position-absolute"
                            style="cursor: pointer; top: 20px;" width="32" height="32" viewBox="0 0 32 32"
                        ...
                        <h2 style="color: #333;padding-top: 10px !important" class="fw-bold mt-3 mb-2" >
                            Enter Details
                        </h2>
                  ...
                  " />
                            ...
                            <div class="d-flex flex-md-row flex-column gap-2 w-100 ">
                                <div class="d-flex flex-column gap-1 w-100 pos-rev ex-padd">
                                    <label for="email" class="text-start text-ora">Email <span>*</span>
                                    </label>
                                    <div class="postion-relative">
                    ...
                    " />
                                ...
                                <div class="d-flex flex-column gap-1 w-100 pos-rev ex-padd">
                                    ...
                                    <input type="tel" name="phnumber" id="phnumber" class="form-control py-2"
                                        style="
                          border: 1px solid #d0d5dd !important;
                          background: #f6f6f6;
                          box-shadow: 0px 1px 2px 0px
                    ...
                    <div class="col-lg-4 col-12 d-flex flex-column p-4 gap-lg-5" style="background-color: #0d3642">
                        <div class="d-flex justify-content-end align-items-center"
                            ...
                            <svg data-bs-dismiss="modal" style="cursor: pointer" xmlns="http://www.w3.org/2000/svg"
...
<!------------------------------ BaseAjax Js starts --------------------->
<script src="{{ asset('js/baseAjax.js') }}"></script>
<!------------------------------ BaseAjax Js ends --------------------->
