        ...
        <div class="footer-main">
            <div class="f-location">
                <a class="footerimg" href="{{ route('frontend.home') }}">
                    <img loading="lazy"
                        ...
                        alt="Sync4Tech Homepage Logo - Your Gateway to Technological Excellence" class="img-fluid" />
                </a>
            ...
            <div class="quick-link">
                ...
                <div class="f-links">
                    ...
                    <span class="footer-link span-link f-linkstag"
                        data-href-value="{{ route('frontend.aboutUs') }}">About Us</span>
                ...
                <div class="f-links">
                    <img width="24" height="24" loading="lazy"
                        ...
                        alt="Arrow Icon - Indicating Direction or Navigation">
                    <span class="footer-link span-link f-linkstag"
                        data-href-value="{{ route('frontend.blogs') }}">Blog</span>
                </div>
                <div class="f-links">
                    <img width="24" height="24" loading="lazy"
                        src="{{ asset('assets/arrow-icon-indicating-direction-or-navigation.svg') }}"
                        alt="Arrow Icon - Indicating Direction or Navigation">
                    <span class="footer-link span-link f-linkstag"
                        data-href-value="{{ route('frontend.projects') }}">Projects</span>
                </div>
                <div class="f-links">
                    <img width="24" height="24" loading="lazy"
                        src="{{ asset('assets/arrow-icon-indicating-direction-or-navigation.svg') }}"
                        alt="Arrow Icon - Indicating Direction or Navigation">
                    <span class="footer-link span-link f-linkstag"
                        data-href-value="{{ route('frontend.partners') }}">Partners</span>
                </div>
                <div class="f-links">
                    <img width="24" height="24" loading="lazy"
                        src="{{ asset('assets/arrow-icon-indicating-direction-or-navigation.svg') }}"
            ...
            <div class="quick-link">
                ...
                <div class="f-main-location">
                    <a href="https://maps.app.goo.gl/MaFm3ZZRrDGkxx3f6" target="_blank" style="display: flex;">
                        <img loading="lazy" src="{{ asset('assets/icon-displaying-location-sign.svg') }}"
                            alt="Icon displaying location sign" class="img-fluid"
...
<script>
    $(document).ready(function(e) {
        $('.closeScheduleModalPopup').click(function() {
            $('#bookapp').modal('hide');
        })
    })
</script>
