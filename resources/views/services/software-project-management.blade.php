    ...
    style="
      ...
      <div class="container">
        <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
          ...
          <a class="text-orange m-0 text-decoration-none" href="{{route('frontend.services.software-project-management')}}">
        ...
        <p class="" style="color: #dfdfdf">
          Project success, from initiation to closure. We define goals, create detailed plans, execute, monitor, and evaluate, ensuring on-time and within-budget delivery.
        </p>
      </div>
        ...
        <div class="timeline-container">
            ...
            <div class="grid-process pb-lg-3">
                <div class="process-content">
                    ...
                    <ul class="process-list">
                        <li class="list-item"> A clear definition of project goals, scope, and stakeholders lays the foundation for effective project management.
                        </li>
                        <li class="list-item">The creation of a project charter establishes the project's purpose, objectives, and key stakeholders.</li>
            ...
            <div class="grid-process pt-lg-3 pb-lg-3">
                ...
                <div class="process-content">
                    ...
                    <ul class="process-list">
                        <li class="list-item">We develop a project plan, breaking down tasks, and setting timelines.</li>
                        <li class="list-item">Defining dependencies to ensure smooth execution.</li>
                        <li class="list-item">Resource identification and allocation of responsibilities in ensuring project alignment with the plan.</li>
            ...
            <div class="grid-process pt-lg-3 ">
                ...
                <div class="process-content">
                    ...
                    <ul class="process-list">
                        <li class="list-item">At project closure, we evaluate the success of the project against predefined objectives</li>
