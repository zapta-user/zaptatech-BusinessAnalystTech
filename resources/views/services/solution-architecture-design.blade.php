...
@php
 ...
 $meta_description = "Build a robust foundation for your software solutions with Sync4Tech’s software architecture design solutions. We blend innovation with functionality creating scalable and efficient systems.";
 @endphp
  <!-- --------------------BANNER SECTION----------------- -->
  <div
    ...
    style="
      ...
      <div class="container">
        <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
          ...
          <a class="text-orange m-0 text-decoration-none" href="{{route('frontend.services.solution-architecture-design')}}">
        ...
        <p class="" style="color: #dfdfdf">
          Crafting solutions aligned with business needs. We analyze requirements, design comprehensive architecture, and deliver detailed documentation.
        </p>
      </div>
      ...
      <div class="timeline-container">
          ...
          <div class="grid-process pb-lg-3">
              <div class="process-content">
                  ...
                  <ul class="process-list">
                      <li class="list-item"> A thorough review of business requirements ensures a clear understanding. </li>
          ...
          <div class="grid-process pt-lg-3 pb-lg-3">
              ...
              <div class="process-content">
                  ...
                  <ul class="process-list">
                      <li class="list-item">Development of a high-level architecture diagram providing a visual representation of the proposed solution's structure.</li>
