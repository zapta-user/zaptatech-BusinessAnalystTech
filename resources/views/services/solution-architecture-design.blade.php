...
@section('section')
    @php
        $meta_title = 'Sync4Tech | Software Architecture Design Services';
        $meta_description =
            'Build a robust foundation for your software solutions with Sync4Tech’s software architecture design solutions. We blend innovation with functionality creating scalable and efficient systems.';
    @endphp
    <!-- --------------------BANNER SECTION----------------- -->
        ...
        <div class="container">
            <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
                ...
                <a class="text-orange m-0 text-decoration-none"
                    href="{{ route('frontend.services.solution-architecture-design') }}">
            ...
            <h1 class="text-white fw-bold">Solution Architecture Design</h1>
            <p class="" style="color: #dfdfdf">
                Crafting solutions aligned with business needs. We analyze requirements, design comprehensive architecture,
                and deliver detailed documentation.
            </p>
        </div>
        ...
        <div class="container">
            ...
            <div class="timeline-container">
                ...
                <div class="grid-process pb-lg-3">
                    <div class="process-content">
                        <div class="content-header">
                            ...
                            <h2 class="content-title">Requirements Analysis </h3>
                        </div>
                        <ul class="process-list">
                            <li class="list-item"> A thorough review of business requirements ensures a clear understanding.
                            </li>
                            <li class="list-item">Identifying system functionalities and constraints </li>
                            <li class="list-item">Design a solution that aligns with business goals.</li>
                ...
                <div class="grid-process pt-lg-3 pb-lg-3">
                    ...
                    <div class="process-content">
                        <div class="content-header">
                            ...
                            <h2 class="content-title"> Design</h3>
                        </div>
                        <ul class="process-list">
                            <li class="list-item">Development of a high-level architecture diagram providing a visual
                                representation of the proposed solution's structure.</li>
                            <li class="list-item">Detailed definition of components, interfaces, and data flow.</li>
                ...
                <div class="grid-process pt-lg-3 ">
                    <div class="process-illustration">
                        <img width="625" height="414" style="max-width: 625px;"
                            src="{{ asset('assets/validation3.webp') }}" alt="illustration">
                    </div>
                    <div class="process-content">
                        <div class="content-header">
                            <img width="625" height="414" style="max-width: 625px;"
                        ...
                        <ul class="process-list">
                            <li class="list-item">Collaborative design review sessions with stakeholders.</li>
                            <li class="list-item">Refine and improve the proposed solution.</li>
                            <li class="list-item"> Make adjustments based on feedback to align with expectations. </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="outcome-card">
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        ...
                        <ul style="padding-left: 1rem;">
                            <li>The final solution architecture addresses business requirements.</li>
                            <li>Architecture aligned with the identified business needs and objectives.</li>
                        </ul>
                ...
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        <h3>Deliverables</h3>
                        <ul style="padding-left: 1rem;">
                            <li>Visual representations of the solution architecture.</li>
                            <li>Detailed documentation outlining the components, interfaces, and data flow.</li>
                        </ul>
