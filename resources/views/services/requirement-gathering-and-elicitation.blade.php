    ...
    style="
      ...
      <div class="container">
        <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
          ...
          <a class="text-orange m-0 text-decoration-none" href="{{route('frontend.services.requirement-gathering-and-elicitation')}}">
        ...
        <p class="" style="color: #dfdfdf">
          Holistic requirement gathering for a clear understanding of stakeholder needs. We identify stakeholders, define roles, and employ various elicitation techniques.
        </p>
      </div>
      ...
      <div class="timeline-container">
          ...
          <div class="grid-process pb-lg-3">
              <div class="process-content">
                  ...
                  <ul class="process-list">
                      <li class="list-item"> Thorough stakeholder identification is involved in the requirement-gathering process. </li>
                      <li class="list-item">A clear definition of roles and responsibilities establishes effective communication channels.</li>
                  </ul>
              </div>
          ...
          <div class="grid-process pt-lg-3 pb-lg-3">
              ...
              <div class="process-content">
                  ...
                  <ul class="process-list">
                      <li class="list-item">Utilizing various elicitation techniques, including interviews, and surveys</li>
                      ...
                      <li class="list-item">The application of elicitation techniques results in accurate requirements.</li>
                  </ul>
              </div>
          </div>
      </div>
