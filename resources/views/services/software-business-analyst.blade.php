...
@section('section')
    @php
        ...
        $meta_description =
            'Bridge the gap between your business goals and technical solutions with Sync4Tech software business analysts. we ensure all your business processes get optimized seamlessly and efficiently.';
    @endphp
    <!-- --------------------BANNER SECTION----------------- -->
        ...
        <div class="container">
            <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
                ...
                <a class="text-orange m-0 text-decoration-none"
                    href="{{ route('frontend.services.software-business-analyst') }}">
            ...
            <p class="" style="color: #dfdfdf">
                Tailored software business analyst to ensure your project's success. We identify stakeholder needs, document
                requirements, and provide comprehensive specifications and visual representations
            </p>
        </div>
            ...
            <div class="timeline-container">
                ...
                <div class="grid-process pb-lg-3">
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item"> Initiate software business analysis by identifying key stakeholders and
                                defining the project scope. </li>
                            <li class="list-item">Ensure alignment with overarching goals by understanding the needs.</li>
                            <li class="list-item"> Examine industry trends for an informed foundation throughout the
                                analysis process </li>
                ...
                <div class="grid-process pt-lg-3 pb-lg-3">
                    ...
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item">Engage stakeholders for insights into business needs and expectations.
                            </li>
                            <li class="list-item">Meticulously record specific project functionalities.</li>
                            <li class="list-item"> Document essential aspects beyond functionalities for a comprehensive
                                project. </li>
                ...
                <div class="grid-process pt-lg-3 ">
                    ...
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item">Conduct collaborative validation sessions and ensure alignment of
                                expectations.</li>
                            <li class="list-item">Gather feedback and utilize it to make necessary adjustments. </li>
                            <li class="list-item"> Guarantee that the finalized requirements accurately reflect business
                                needs.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="d-flex w-100 justify-content-between align-items-center">
                            <h1 style="display: flex; justify-content: center;margin: 0 auto 16px;color:#FB7A00;">Become
                                Our Partner
                            </h1>
