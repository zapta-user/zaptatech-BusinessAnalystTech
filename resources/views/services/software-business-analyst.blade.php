  ...
  <div
    ...
    <div class="container">
      <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
        ...
        <a class="text-orange m-0 text-decoration-none" href="{{route('frontend.services.software-business-analyst')}}">
      ...
      <h1 class="text-white fw-bold">Software Business Analyst</h1>
      <p class="" style="color: #dfdfdf">
        Tailored software business analyst to ensure your project's success. We identify stakeholder needs, document requirements, and provide comprehensive specifications and visual representations
      </p>
    </div>
      ...
      <div class="timeline-container">
        ...
        <div class="grid-process pb-lg-3">
          <div class="process-content">
            <div class="content-header">
              <img width="60" height="60" src="{{asset('assets/discover1.svg')}}" alt="file icon">
              <h2 class="content-title">Initiation</h3>
            </div>
            <ul class="process-list">
              <li class="list-item"> Initiate software business analysis by identifying key stakeholders and defining the project scope. </li>
              <li class="list-item">Ensure alignment with overarching goals by understanding the needs.</li>
              <li class="list-item"> Examine industry trends for an informed foundation throughout the analysis process </li>
          ...
          <div class="process-illustration">
            <img width="625" height="414" style="max-width: 625px;" src="{{asset('assets/Initiation5.webp')}}">
          </div>
        </div>
        ...
        <div class="row">
          <div class="wireframe col-12 text-center">
            ...
            <img width="190" height="214" class="" src="{{asset('assets/wireframe2.svg')}}" alt="timeline">
          </div>
        </div>

        <div class="grid-process pt-lg-3 pb-lg-3">
          <div class="process-illustration">
            <img width="625" height="414" style="max-width: 625px;" src="{{asset('assets/Initiation2.webp')}}" alt="illustration">
          </div>
          <div class="process-content">
            <div class="content-header">
              <img width="60" height="60" src="{{asset('assets/discover2.svg')}}" alt="file icon">
              <h2 class="content-title">Requirement Gathering</h3>
            </div>
            <ul class="process-list">
              <li class="list-item">Engage stakeholders for insights into business needs and expectations.</li>
              <li class="list-item">Meticulously record specific project functionalities.</li>
              <li class="list-item"> Document essential aspects beyond functionalities for a comprehensive project. </li>
        ...
        <div class="row">
          <div class="wireframe col-12 text-center">
            <img width="190" height="214" src="{{asset('assets/wireframe1.svg')}}" alt="timeline">
          </div>
        </div>
        ...
        <div class="grid-process pt-lg-3 pb-lg-3">
          <div class="process-content">
            <div class="content-header">
              <img width="60" height="60" src="{{asset('assets/discover3.svg')}}" alt="file icon">
              <h2 class="content-title">Analysis</h3>
            </div>
            <ul class="process-list">
              <li class="list-item"> Create use cases, user stories, and process flow with clarity  </li>
              <li class="list-item">Utilize tools and provide insights for informed decision-making.</li>
              <li class="list-item"> Document findings contributing to the project's success. </li>
          ...
          <div class="process-illustration">
            <img width="625" height="414" style="max-width: 625px;" src="{{asset('assets/Initiation3.webp')}}" alt="illustration">
          </div>
        </div>

        <div class="row">
          <div class="wireframe col-12 text-center">
            <img width="190" height="214" src="{{asset('assets/wireframe2.svg')}}" alt="timeline">
          </div>
        </div>

        <div class="grid-process pt-lg-3 ">
          <div class="process-illustration">
            <img width="625" height="414" style="max-width: 625px;" src="{{asset('assets/validation.webp')}}" alt="illustration">
          </div>
          <div class="process-content">
            <div class="content-header">
              <img width="60" height="60" src="{{asset('assets/discover4.svg')}}" alt="file icon">
              <h2 class="content-title">Validation</h3>
            </div>
            <ul class="process-list">
              <li class="list-item">Conduct collaborative validation sessions and ensure alignment of expectations.</li>
              <li class="list-item">Gather feedback and utilize it to make necessary adjustments. </li>
              <li class="list-item"> Guarantee that the finalized requirements accurately reflect business needs.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="outcome-card">
        <div class="outcom-p">
          ...
          <div class="out-ul">
            ...
            <ul style="padding-left: 1rem;">
              <li>Detailed roadmap for the development phase. </li>
              <li>Aid in communicating complex concepts to diverse stakeholders.</li>
            </ul>
        ...
        <div class="outcom-p">
          ...
          <div class="out-ul">
            <h3>Deliverables</h3>
            <ul style="padding-left: 1rem;">
              <li>Detailed document outlining functional and non-functional requirements.
              </li>
              <li>Clear visuals (process flows, diagrams) enhance understanding and communication.
              </li>
            </ul>
    ...
    <div class="container">
      ...
      <div class="contentSection">
        ...
        <p class="provide-business">
          Our business analysis services provide in-depth requirement gathering, process improvement, and data analysis
          to
