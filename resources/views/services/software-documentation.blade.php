...
@section('section')
    @php
        $meta_title = 'Sync4Tech | Software Documentation';
        $meta_description =
            "Level up your software development journey with Sync4Tech's comprehensive Software Documentation Services. From detailed specifications to user manuals, our expert team ensures clear and effective documentation, enhancing project transparency and success.";
    @endphp
    <!-- --------------------BANNER SECTION----------------- -->
        ...
        <div class="container">
            <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
                ...
                <a class="text-orange m-0 text-decoration-none"
                    href="{{ route('frontend.services.software-documentation') }}">
            ...
            <h1 class="text-white fw-bold">Software Documentation</h1>
            <p class="" style="color: #dfdfdf">
                ...
                documentation needs, and deliver user-friendly manuals and technical documentation.
            </p>
        </div>
                ...
                <div class="grid-process pb-lg-3">
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item">A deep understanding of the system is the starting point for
                                documentation. </li>
                            <li class="list-item">Identifying the specific documentation needs</li>
                            <li class="list-item">Ensures the documentation is tailored to the software's intricacies.</li>
                ...
                <div class="grid-process pt-lg-3 pb-lg-3">
                    ...
                    <div class="process-content">
                        <div class="content-header">
                            ...
                            <h2 class="content-title"> Documentation Creation</h3>
                        </div>
                        <ul class="process-list">
                            <li class="list-item">We create user-friendly manuals, technical documentation, and FAQs </li>
                            <li class="list-item">We cater to different user needs and skill levels.</li>
                            <li class="list-item">Clarity and conciseness are prioritized to facilitate user adoption.</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="outcome-card">
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        ...
                        <ul style="padding-left: 1rem;">
                            <li>The result is comprehensive and user-friendly documentation
                            </li>
                            <li>Improved user understanding and quicker adoption of the software.</li>
                        </ul>
                ...
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        <h3>Deliverables</h3>
                        <ul style="padding-left: 1rem;">
                            <li>Detailed guides for end-users, offering step-by-step instructions.</li>
                            <li>In-depth documentation for developers and IT professionals.
                            </li>
                        </ul>
