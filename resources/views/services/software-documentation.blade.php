...
@php
 ...
 $meta_description = "Level up your software development journey with Sync4Tech's comprehensive Software Documentation Services. From detailed specifications to user manuals, our expert team ensures clear and effective documentation, enhancing project transparency and success.";
@endphp
  <!-- --------------------BANNER SECTION----------------- -->
  <div
    ...
    style="
      ...
      <div class="container">
        <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
          ...
          <a class="text-orange m-0 text-decoration-none" href="{{route('frontend.services.software-documentation')}}">
        ...
        <p class="" style="color: #dfdfdf">
          Clear, comprehensive documentation for seamless system understanding. We analyze software, identify documentation needs, and deliver user-friendly manuals and technical documentation.
        </p>
      </div>
          ...
          <div class="grid-process pb-lg-3">
              <div class="process-content">
                  ...
                  <ul class="process-list">
                      <li class="list-item">A deep understanding of the system is the starting point for documentation. </li>
