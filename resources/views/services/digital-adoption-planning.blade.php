...
@section('section')
    @php
        $meta_title = 'Sync4Tech | Digital Adoption Planning Services';
        $meta_description =
            'Transform your existing business process with Sync4Tech digital adoption planning services where we craft seamless software integration plans leading to maximum user engagement and productivity.';
    @endphp
    <!-- --------------------BANNER SECTION----------------- -->
    <div class="bannerSection flex-column gap-lg-4 gap-3 d-flex align-items-start justify-content-center  flex-shrink-0"
        style="
        background-image: url('{{ asset('assets/services-detail-7.webp') }}');
        ...
        <div class="container">
            <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
                ...
                <a class="text-orange m-0 text-decoration-none"
                    href="{{ route('frontend.services.digital-adoption-planning') }}">
            ...
            <p class="" style="color: #dfdfdf">
                Strategic digital adoption for improved business processes. We assess goals, explore systems, and provide a
                roadmap for successful digital adoption.
            </p>
        </div>
            ...
            <div class="timeline-container">
                ...
                <div class="grid-process pb-lg-3">
                    <div class="process-content">
                        <div class="content-header">
                            ...
                            <h2 class="content-title">Business Assessment</h3>
                        </div>
                        <ul class="process-list">
                            <li class="list-item"> A thorough business assessment involves identifying overarching goals,
                                specific requirements, and current business processes. </li>
                            <li class="list-item">Exploration of available systems ensures a tailored digital adoption
                                strategy.
                            </li>
                        </ul>
                    </div>
                ...
                <div class="grid-process pt-lg-3 pb-lg-3">
                    ...
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item">We craft a strategy and roadmap for digital adoption</li>
                            <li class="list-item">Outlining the steps to be taken for successful implementation.</li>
                            <li class="list-item">Create a plan and documentation for the adoption plan.</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="outcome-card">
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        ...
                        <ul style="padding-left: 1rem;">
                            <li>Improved business processes and increased efficiency.</li>
                            <li>The strategy ensures widespread adoption across the organization.</li>
                        </ul>
                ...
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        <h3>Deliverables</h3>
                        <ul style="padding-left: 1rem;">
                            <li>A detailed plan outlining the strategy for digital adoption.</li>
                            <li>The identification of systems aligns with business goals.
                            </li>
                        </ul>
