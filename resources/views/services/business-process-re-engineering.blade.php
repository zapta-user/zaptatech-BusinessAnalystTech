...
@section('section')
    @php
        ...
        $meta_description =
            "Revitalize your business with Sync4Tech's Business Process Re-Engineering services. Streamline operations, enhance efficiency, and boost productivity through our tailored solutions.";
    @endphp
    <!-- --------------------BANNER SECTION----------------- -->
    <div class="bannerSection flex-column gap-lg-4 gap-3 d-flex align-items-start justify-content-center  flex-shrink-0"
        style="
        background-image: url('{{ asset('assets/service-detail-page-1.webp') }}');
        ...
        <div class="container">
            <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
                ...
                <a class="text-orange m-0 text-decoration-none"
                    href="{{ route('frontend.services.business-process-re-engineering') }}">
            ...
            <h1 class="text-white fw-bold">Business Process Re-Engineering</h1>
            <p class="" style="color: #dfdfdf">
                Revitalize your processes for enhanced efficiency. We analyze current workflows, redesign optimized
                processes, and provide a detailed implementation plan.
            </p>
        </div>
            ...
            <div class="timeline-container">
                ...
                <div class="grid-process pb-lg-3">
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item"> Analyze existing processes and identify pain points, document current
                                workflows. </li>
                            <li class="list-item">Perform a SWOT analysis for a holistic view</li>
                            <li class="list-item">Integrate performance metrics into redesigned processes.</li>
                        </ul>
                    </div>
                ...
                <div class="grid-process pt-lg-3 pb-lg-3">
                    ...
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item">Conduct brainstorming sessions and design streamlined processes.</li>
                            <li class="list-item">Incorporate industry best practices with industry best practices.</li>
                            <li class="list-item">Leverage technological advancements for optimized workflows.</li>
                ...
                <div class="grid-process pt-lg-3 pb-lg-3">
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item"> Create a phased plan for deploying redesigned processes. </li>
                            <li class="list-item">Outline steps to avoid disrupting normal business operations.</li>
                            <li class="list-item"> Define KPIs to measure re-engineering success against predetermined
                                benchmarks.</li>
                ...
                <div class="grid-process pt-lg-3 ">
                    <div class="process-illustration">
                        <img width="625" height="414" style="max-width: 625px;"
                            src="{{ asset('assets/step-4-of-sync4tech-service-1.webp') }}"
                            alt="Step 4 of Sync4Tech Service 1">
                    </div>
                    <div class="process-content">
                        <div class="content-header">
                            <img width="60" height="60" src="{{ asset('assets/discover-icon-image-4.svg') }}"
                                alt="Discover Icon image 4">
                            <h2 class="content-title">Monitoring and Continuous Improvement
                                </h3>
                        </div>
                        <ul class="process-list">
                            <li class="list-item">ReDeploy systems for instant oversight of redesigned processes.
                            </li>
                            <li class="list-item">Regularly analyze key performance indicators and relevant metrics.</li>
                            <li class="list-item"> Establish continuous feedback mechanisms with stakeholders and
                                end-users. </li>
                            <li class="list-item">Act on identified opportunities for ongoing efficiency gains.</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="outcome-card">
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        ...
                        <ul style="padding-left: 1rem;">
                            <li>Processes are streamlined and optimized for efficiency.</li>
                            <li>Businesses experience enhanced operational efficiency, leading to improved overall
                                performance. </li>
                        </ul>
                ...
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        <h3>Deliverables</h3>
                        <ul style="padding-left: 1rem;">
                            <li>Visual representations of optimized processes </li>
                            <li>Detailed plan outlining the phased approach for implementing redesigned processes.</li>
                        </ul>
