...
@section('section')
    @php
        $meta_title = 'Sync4Tech | Data Analysis Services';
        $meta_description =
            'Discover Sync4Tech data analysis services where our expert team employs advanced analytics tools to extract insights, optimize decision making, and drive business growth. We transform your data into a strategic asset to meet your business needs.';
    @endphp
    <!-- --------------------BANNER SECTION----------------- -->
    <div class="bannerSection flex-column gap-lg-4 gap-3 d-flex align-items-start justify-content-center  flex-shrink-0"
        style="
        background-image: url('{{ asset('assets/main-services-banner.webp') }}');
      ...
      ">
        <div class="container">
            <div class="home-links d-flex flex-wrap gap-2 align-items-center pb-lg-3 pb-2 pt-2">
                ...
                <a class="text-orange m-0 text-decoration-none" href="{{ route('frontend.services.data-analysis') }}">
                    Data Analysis
                </a>
            ...
            <h1 class="text-white fw-bold">Data Analysis</h1>
            <p class="" style="color: #dfdfdf">
                Uncover insights through meticulous data analysis. We identify sources, collect data, and apply statistical
                methods to provide meaningful insights.
            </p>
        </div>
            ...
            <div class="timeline-container">
                ...
                <div class="grid-process pb-lg-3">
                    <div class="process-content">
                        <div class="content-header">
                            ...
                            <h2 class="content-title">Data Collection</h3>
                        </div>
                        <ul class="process-list">
                            <li class="list-item"> Identification of relevant data sources ensures the inclusion of data
                            </li>
                            <li class="list-item">Meticulous data gathering from identified sources</li>
                            <li class="list-item">Provides a comprehensive dataset for analysis.
                            </li>
                        </ul>
                    </div>
                ...
                <div class="grid-process pt-lg-3 pb-lg-3">
                    ...
                    <div class="process-content">
                        ...
                        <ul class="process-list">
                            <li class="list-item">Leveraging statistical and analytical methods.</li>
                            <li class="list-item">Extract meaningful insights from the collected data.</li>
                            <li class="list-item">Focuses on fetching insights that contribute to informed decision-making.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="outcome-card">
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        ...
                        <ul style="padding-left: 1rem;">
                            <li>Achieve an in-depth understanding of data patterns and trends.</li>
                            <li>Insights derived from data analysis for making informed decisions.</li>
                        </ul>
                ...
                <div class="outcom-p">
                    ...
                    <div class="out-ul">
                        <h3>Deliverables</h3>
                        <ul style="padding-left: 1rem;">
                            <li>Data analysis reports: Comprehensive reports outlining the findings and insights derived
                                from data analysis.</li>
                            <li>Visualisations and insights: Visual representations of data patterns and key insights for
