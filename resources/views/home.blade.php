...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./css/myStyle.css" async>

  <meta name="title" content="Sync4Tech: Global Software Development & Business Partner">
  <meta name="description" content="Digitize your business with Sync4Tech, a global business partner & business analyst in software development, We offer futuristic technology solutions for businesses enhancing efficiency and driving growth.">
  ...
  <meta property="og:description" content="Digitize your business with Sync4Tech, a global business partner & business analyst in software development, We offer futuristic technology solutions for businesses enhancing efficiency and driving growth.">
  ...
  <meta name="twitter:description" content="Digitize your business with Sync4Tech, a global business partner & business analyst in software development, We offer futuristic technology solutions for businesses enhancing efficiency and driving growth.">
...
<body>
    ...
    <div class="container">
      <navbar class="navbar">
        <a class="navbar-brand d-lg-block d-none" href="{{route('frontend.home')}}" id="defaultlogo">
          <img loading="lazy" width="216" height="40" src="{{asset('assets/home-logo.svg')}}" alt="logo" class="img-fluid" />
        </a>
        ...
        <div class="nav-items">
          <a class="nav-link mx-2 pb-2 active" aria-current="page" href="{{route('frontend.home')}}">Home</a>
  ...
  <section class="hero-section pt-80">
    <div class="container">
      <div class="hero-content">
        ...
        <p class="business-p">
          Our team empowers your strategy with comprehensive business analysis services. We specialize in streamlined requirement gathering, process improvement, and data analysis, ensuring optimal operations for your business success.
        </p>
        ...
        <div class="d-flex gap-lg-4 justify-content-center gap-3 pt-5 bottomImg">
          ...
          <a href="mailto:info@sync4tech.co" target="_blank" style="text-decoration: none !important; border: none;">
      ...
      <div class="main-services-cards">
        ...
        <div class="card serviceCard1">
          <div class="business-Process">
            <div class="">
              <img loading="lazy" width="80" height="80" src="{{asset('assets/service1.svg')}}" alt="Research" class="img-fluid" />
            </div>
            <h6>Software Business Analysis</h6>
          </div>
        ...
        <div class="card serviceCard1">
          <div class="business-Process">
            <div class="">
              <img loading="lazy" width="80" height="80" src="{{asset('assets/service2.svg')}}" alt="Research" class="img-fluid" />
            </div>
        ...
        <div class="card serviceCard1">
          <div class="business-Process">
            <div class="">
              <img loading="lazy" width="80" height="80" src="{{asset('assets/service3.svg')}}" alt="Research" class="img-fluid" />
            </div>
        ...
        <div class="card serviceCard1">
          <div class="business-Process">
            <div class="">
              <img loading="lazy" width="80" height="80" src="{{asset('assets/service4.svg')}}" alt="Research" class="img-fluid" />
            </div>
        ...
        <div class="card serviceCard1">
          <div class="business-Process">
            <div class="">
              <img loading="lazy" width="80" height="80" src="{{asset('assets/service5.svg')}}" alt="Research" class="img-fluid" />
            </div>
        ...
        <div class="card serviceCard1">
          <div class="business-Process">
            <div class="">
              <img loading="lazy" width="80" height="80" src="{{asset('assets/service6.svg')}}" alt="Research" class="img-fluid" />
            </div>
            <h6>Data Analysis</h6>
          </div>
          <div class="services-card">
  ...
  <!-- ------------TOOLS SECTION---------------- -->
  <section
    class="cardsSection toolCardSection d-flex flex-column justify-content-center align-items-center gap-5 toolim"
    ...
    <div class="container">
      ...
      <div class="contentSection d-flex flex-column justify-content-center align-items-center gap-3">
        ...
        <h1 class="dark-black text-center fw-bold">Tools We Use</h1>
        <p class="content-color text-center px-xl-5 pb-5">
          Achieve success using the latest, advanced tools for peak performance.
        </p>
      </div>
      <!-- ------------CARDS SECTION---------------- -->
      <div class="sliderUse">
        <div class="slide-track-use">
          <div class="slideUse">
            <div data-animation="fadeIn" data-animation-delay=".3s"
              ...
              <img loading="lazy" width="58" height="70" src="{{asset('assets/office-1.svg')}}" alt="office-1" class="img-fluid" />
          ...
          <div class="slideUse">
            <div data-animation="fadeIn" data-animation-delay=".3s"
              class="toolCard d-flex flex-column gap-3 justify-content-center align-items-center">
              <img loading="lazy" width="47" height="70" src="{{asset('assets/figma-5.svg')}}" alt="figma-5" class="img-fluid" />
          ...
          <div class="slideUse">
            <div data-animation="fadeIn" data-animation-delay=".3s"
              class="toolCard d-flex flex-column gap-3 justify-content-center align-items-center">
              <img loading="lazy" width="70" height="70" src="{{asset('assets/smileyface.svg')}}" alt="smileyface"
                class="img-fluid" />
          ...
          <div class="slideUse">
            <div data-animation="fadeIn" data-animation-delay=".3s"
              class="toolCard d-flex flex-column gap-3 justify-content-center align-items-center">
              <img loading="lazy" width="60" height="60" src="{{asset('assets/microsoftsuite.svg')}}" alt="microsoftsuite" class="img-fluid" />
          ...
          <div class="slideUse">
            <div data-animation="fadeIn" data-animation-delay=".3s"
              class="toolCard d-flex flex-column gap-3 justify-content-center align-items-center">
              <img loading="lazy" width="70" height="70" src="{{asset('assets/base.svg')}}" alt="basecamp" class="img-fluid" />
    ...
    <div class="container">
      ...
      <div class="contentSection d-flex flex-column justify-content-center align-items-center gap-3">
        ...
        <p class="content-color text-center px-xl-5 pb-lg-4 pb-3">
          Explore Our Recent Projects, Where Collaborative Excellence Drives Success Stories. Feel the influence of our custom solutions and commitment to delivering results.
        </p>
      </div>
      <div
        class="w-100 d-flex flex-wrap flex-sm-row flex-column justify-content-center align-items-center gap-3 grid-container"
        ...
        <div class="small-div d-flex flex-column x-gap" style="height: 630px;">
          <div class="position-relative w-100 viewprojectmain">
            <div class="viewproject d-flex justify-content-center align-items-center w-100" style="
            height: 315px;
            background-image: url(./assets/Quick-Stepsport1.webp);
            background-position: center;
            background-size: cover;
          "></div>
            <div
              class="w-100 h-100 d-flex justify-content-center align-items-center position-absolute showbutton top-0">
              <button id="scrollToSection2" style="border: 2px solid #fb7a00 !important;font-weight:600 !important;"
          ...
          <div class="w-100 d-flex flex-sm-row flex-column gap-3 align-items-center" style="height: 315px">
            <div class="position-relative w-100 viewprojectmain mt-lg-3">
              <div class="viewproject w-100 d-flex justify-content-center align-items-center" style="
              background-image: url(./assets/Quick-Stepsport3.webp);
              background-position: center;
              background-size: cover;
              height: 315px;
            "></div>
            ...
            <div class="position-relative w-100 viewprojectmain mt-lg-3">
              <div class="viewproject w-100 d-flex justify-content-center align-items-center" style="
              background-image: url(./assets/Quick-Stepsport4.webp);
              background-position: center;
              background-size: cover;
              height: 315px;
            "></div>
              <div
                ...
                <button id="scrollToSection2" style="border: 2px solid #fb7a00 !important;font-weight:600 !important;"
                  class="btn navButton bg-transparent rounded-0 button-color justify-content-center align-items-center gap-3">
                  <a href="{{route('frontend.projects.qme-solutions')}}" class="text-orange">Know More</a>
                </button>
              </div>
            </div>
          </div>
        ...
        <div class="large-div d-flex justify-content-center">
          <div class="position-relative w-100 viewprojectmain">
            <div class="viewproject d-flex w-100 justify-content-center align-items-center" style="
            height: 640px;
            background-image: url(./assets/Quick-Stepsport2.webp);
            background-position: center;
            background-size: cover;
          "></div>
            <div
      ...
      <a style="max-width: 209px;" href="{{route('frontend.projects')}}" class="View-More-btn mt-5">View More Projects</a>
  ...
  <section class="pt-lg-5 pb-lg-4 pt-3 pb-3" style="background-color: #E1E7E9">
    <div class="container">
      <div class="sliderUse">
        <div class="slide-track-use">
          <div class="slideUse">
            <img loading="lazy" width="129" height="30" src="{{asset('assets/log1.svg')}}" alt="quick_step" class="img-fluid fab" />
          </div>
          <div class="slideUse">
            <img loading="lazy" width="172" height="40" src="{{asset('assets/log2.svg')}}" alt="techHouse" class="img-fluid fab " />
          </div>
          <div class="slideUse">
            <img loading="lazy" width="178" height="27" src="{{asset('assets/log3.svg')}}" alt="Saudi_Bank_Digital" class="img-fluid fab " />
          </div>
          <div class="slideUse">
          ...
          <div class="slideUse">
            <img loading="lazy" width="178" height="29" src="{{asset('assets/log5.svg')}}" alt="ExpressText" class="img-fluid fab " />
          </div>
          <div class="slideUse">
            <img loading="lazy" width="178" height="39" src="{{asset('assets/log6.svg')}}" alt="Lahebo" class="img-fluid fab" />
          </div>
          <div class="slideUse">
            <img loading="lazy" width="53" height="40" src="{{asset('assets/log7.svg')}}" alt="TAMIMI" class="img-fluid fab " />
          </div>
          <div class="slideUse">
             <img loading="lazy" width="129" height="30" src="{{asset('assets/log1.svg')}}" alt="quick_step" class="img-fluid fab" />
          </div>
          ...
          <div class="slideUse">
            <img loading="lazy" src="{{asset('assets/log1.svg')}}" alt="QuickSteps" class="img-fluid fab" />
          </div>
          <div class="slideUse">
            <img loading="lazy" width="172" height="40" src="{{asset('assets/log2.svg')}}" alt="techHouse" class="img-fluid fab " />
          </div>
  ...
  <section class="cardsSection toolCardSection d-flex flex-column justify-content-center align-items-center gap-5"
    ...
    <div class="container">
      ...
      <div data-animation="fadeIn" data-animation-delay=".3s"
        ...
        <h1 class="dark-black text-center fw-bold">Our Blog & Articles</h1>
        <p class="content-color text-center px-xl-5 pb-3 ">
          Explore a world of knowledge with Sync4tech's compelling blogs and articles. Explore expert insights, industry trends, and invaluable tips that propel your path to success. 
        </p>
      </div>
      <!-- ------------CARDS SECTION---------------- -->
      <div class="row d-flex  justify-content-center blogzoom flex-md-row flex-column gap-3 w-100">
        ...
        <!-- card-2 -->
        <div class="blogCard d-flex blogPost flex-column align-items-md-start align-items-center justify-content-center gap-md-3 gap-1 p-3">
  ...
  <section data-animation="fadeIn" data-animation-delay=".3s" id="contactSection"
    ...
    <div class="container">
      <div class="d-flex flex-column gap-lg-3 gap-2">
        ...
        <h1 class="dark-black text-center fw-bold">Let's Talk</h1>
        <p class="content-color text-center px-xl-5 mx-xl-5 pb-lg-5 pb-3 contentsectioncontent">
          Get in touch with Sync4tech! Your inquiries matter to us. Contact our team for prompt and personalized assistance – turning your questions into solutions and ideas into action.
        </p>
      </div>
      <div class="d-flex flex-md-row flex-column gap-3" style="align-items: center;">
        ...
        <div class="subDiv formSection d-flex flex-column gap-2 align-items-md-start align-items-center">
          <form action="#"
            class="d-flex flex-column gap-3 align-items-md-start align-items-center ms-lg-2 w-100 ps-lg-5 ps-2 pe-lg-5 pe-2"
            id="myForm">
            ...
            <div class="d-flex flex-column gap-2 w-100 pos-rev">
              ...
              <input type="text" name="contactemail" id="contactemail" placeholder="abc@gmail.com"
                class="form-control py-2 px-3 rounded-0 bg-transparent" />
              <div id="contactemailError" class="text-danger pos-abs"></div>
            </div>
            <div class="d-flex flex-column gap-2 w-100 pos-rev">
              <label for="contactphoneNum">Phone</label>
              <input type="tel" name="contactphoneNum" id="contactphoneNum"
        ...
        <div class="modal-content book-modal-content firstDivModal">
          ...
          <div class="row justify-content-center w-100 secondDiv" id="div3"
            ...
            <div
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="position-absolute" style="cursor: pointer; top: 20px;"
              ...
              <form action="#" id="bookconsultform" class="w-100 d-flex align-items-start flex-column gap-3">
                ...
                <div class="d-flex flex-column gap-1 w-100">
                  ...
                  <textarea name="message" id="message" cols="5" class="border-0 p-2 text-orange form-control" rows="5"
                    placeholder="Share anything here..." style="
                        color: #fb7a00;
                        border: 1px solid #d0d5dd !important;
  ...
  <script src="./js/availableslot.js"></script>
