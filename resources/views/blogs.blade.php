...
<head>
  ...
  <title>Blogs | Sync4Tech</title>
  <meta name="description" content=" Dive into Sync4Tech’s insightful blog for expert perspectives and industry trends curated by our team of tech business analysts. 
      " />
  <meta name="keywords"
...
<body>
  ...
  <div
    ...
    <p class="text-start px-md-0 " style="color: #dfdfdf">
      Welcome to Sync4Tech's Blog Hub—where knowledge meets innovation. Stay informed, inspired, and empowered with our latest tech and business analysis insights
    </p>
  </div>
  <!-- ------------------------BLOG SECTION--------------- -->
  <div class="container">
    <div class="cardsSection d-flex flex-column justify-content-center gap-md-5 gap-3 ">
      ...
      <div class="w-100 row d-flex align-items-lg-start justify-content-center gap-3">
        <div
          ...
          <a style="text-decoration: none;"  href="{{route('frontend.blogs.agile-methodology-and-business-analysis')}}">
            <div
          ...
          <a style="text-decoration: none;" href="{{route('frontend.blogs.ensuring-project-success-in-software-development')}}">
            <div
              class="blogCard w-100 ms-lg-2 d-flex flex-column align-items-sm-start align-items-center justify-content-center gap-g-4 gap-3 p-3"
              style="">
              <div class="position-relative w-100">
        ...
        <div
          ...
          <div class="w-100 d-flex align-items-center gap-1 py-xl-3 py-sm-2 py-1 px-3 position-relative"
            ...
            <div
              class="search-result-container flex-column justify-content-center align-items-lg-start align-items-center w-100 start-0 border rounded-3 p-3 position-absolute"
  ...
  <div class="cardsSection d-flex flex-column justify-content-center gap-md-5 gap-1 allBlogSec"
    ...
    <div class="row d-flex  justify-content-center blogzoom flex-md-row flex-column gap-3 w-100">
      ...
      <div
        ...
        <div class="position-relative w-100" style="
          ...
          max-height: 400px;
          height: 300px; ">
          <button class="position-absolute py-1 px-4 border-0" style="top: 6%; right: 4%;background: rgba(255, 255, 255, 0.64); backdrop-filter: blur(2px); ">
            <span style="color: #0d3642" class="fw-bold">Agile Development</span>
          </button>
        </div>
    ...
    <br>
    <ul class="pagination d-flex list-unstyled p-0 justify-content-center align-items-center gap-lg-5 gap-4 w-100"></ul>
  </div>
  <!-- Modal -->
...
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width: 1100px !important;">
  <div class="modal-content contact-model p-0"
    ...
    <button
      style="background-color: #24829914;position: absolute;top: 15
      px;right: 20px;z-index: 1;width: 27px;height: 27px;border-radius: 40px;"
