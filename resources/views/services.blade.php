...
<head>
  ...
  <title>Services | Sync4Tech</title>
  <meta name="description" content="Get to know what services Sync4Tech brings to the table by leveraging their Tech Business Analysts expertise. 
      " />
  <meta name="keywords"
...
<body>
  ...
  <div
    ...
    <div class="container">
      ...
      <p class="text-lg-start" style="color: #dfdfdf">
        Start your Transformational Journey with Sync4Tech.Get to Know and Explore the Tech Solutions crafted by our expert business analysts</p>
    </div>
    ...
    <div class="container">
      ...
      <div class="contentSection">
        ...
        <p class="provide-business">
          Empower your business with our expertise in process improvement, data analysis, project management, and more. We redefine operations for success through tailored solutions
        </p>
      </div>
      <!-- ------------CARDS SECTION---------------- -->
      <div class="main-services-cards">
        ...
        <div class="card serviceCard1">
          ...
          <div class="services-card">
            <p>
              Tailored software business analysis to ensure your project's success. We identify stakeholder needs,
        ...
        <div class="card serviceCard1">
          ...
          <div class="services-card">
            <p>
              Clear, comprehensive documentation for seamless system understanding. We analyze software, identify
        ...
        <div class="card serviceCard1">
          ...
          <div class="services-card">
            <p>
              Strategic digital adoption for improved business processes. We assess goals, explore systems, and provide
              a roadmap for successful digital adoption.
              ..
            </p>
            <a href="{{route('frontend.services.digital-adoption-planning')}}" class="know-more">Know More</a>
          </div>
        </div>
        <!-- 8 -->
        <div class="card serviceCard1">
          ...
          <div class="services-card">
            <p>Holistic requirement gathering for a clear understanding of stakeholder needs. We identify stakeholders,
              define roles, and employ various elicitation techniques.
              ..
            </p>
            <a href="{{route('frontend.services.requirement-gathering-and-elicitation')}}" class="know-more">Know More</a>
          </div>
        </div>
        <!-- 9 -->
        <div class="card serviceCard1">
          ...
          <div class="services-card">
            <p>Incorporate cutting-edge technologies into your projects. We assess technologies, implement solutions,
              and deliver improved system performance.
              ..</p>
            <a href="{{route('frontend.services.technical-research-and-development')}}" class="know-more">Know More</a>
          </div>
        </div>
  ...
  <!-- ------------SERVICE SECTION---------------- -->
  <!-- <div class="w-100 cardsSection d-flex flex-column justify-content-center align-items-center gap-5">
   
    <div class="contentSection d-flex flex-column justify-content-center align-items-center gap-3">
      <p class="text-orange text-center">OUR SERVICES</p>
      <h1 class="dark-black text-center fw-bold">Providing Best Services</h1>
      <p class="content-color text-center">
        Our business analysis services provide in-depth requirement gathering,
        process improvement, and data analysis to help you optimize operations
        and achieve your business objectives.
      </p>
    </div>
 
    <div class="cd-sec" style="position: relative; display: flex;padding-top: 48px !important;">
      <div style="top: 0;left: 0;width: 32.5%;">
        <div data-animation="slideInDown" data-animation-delay=".3s"
          class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
          style="background-color: #FAFAFA !important;">
          <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
            <div class="d-flex align-items-center justify-content-md-start justify-content-center">
              <img src="./assets/service1.svg" alt="Research" class="img-fluid" style="" />
            </div>
            <h6 class="dark-black fw-medium text-md-start text-center">
              Business Process Modeling
            </h6>
          </div>
          <div class="d-flex flex-column gap-3 p-md-4 p-3">
            <p class="brown lh-lg text-md-start text-center">
              Revolutionize your business operations with our dynamic business process modeling service. We provide
              easy-to-understand process flowcharts, detailed business process models, and practical optimization
              recommendations to enhance your
            </p>
            <p class="cardDetails brown" style="margin-top: -15px !important;"> workflows.</p>
          </div>
        </div>
        <div data-animation="slideInDown" data-animation-delay=".3s"
          class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center mt-lg-3"
          style="background-color: #FAFAFA !important;">
          <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
            <div class="d-flex align-items-center justify-content-md-start justify-content-center">
          ...
          <div class="d-flex flex-column gap-3 p-md-4 p-3 bg-colr">
            <p class="brown lh-lg text-md-start text-center">
              Boost your business strategies with our data-driven reports uncover valuable insights and spot emerging
              trends. Furthermore, we specialize in identifying expansion opportunities by optimizing your operations
              and enhancing overall productivity.
            </p>
          </div>
        </div>
      </div>
      <div style="top: 0;left: 0;right: 0;margin: 0 auto !important;width: 32.5%;">
        <div data-animation="slideInDown" data-animation-delay=".3s"
          class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
          style="background-color: #FAFAFA !important;">
          <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          ...
          <div class="d-flex flex-column gap-3 p-md-4 p-3 bg-colr">
            <p class="brown lh-lg text-md-start text-center">
              Empower your software projects with our proven project management expertise facilitating efficient
              execution, superior quality, and transparent progress tracking. You’ll stay updated with project status
              reports, and resource allocation plans, and benefit
            </p>
            <p class="cardDetails brown" style="margin-top: -15px !important;">
              from comprehensive testing reports</p>
          </div>
        </div>
        <div data-animation="slideInDown" data-animation-delay=".3s"
          class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center mt-lg-3"
          ...
          <div class="d-flex flex-column gap-3 p-md-4 p-3 bg-colr">
            <p class="brown lh-lg text-md-start text-center">
              Elevate software understanding, with our user-centric guides, that minimize learning curves and maximize
              proficiency. Our troubleshooting manuals simplify support processes, ensuring efficient issue resolution
              and version release notes keep users informed.
            </p>
          </div>
        </div>
      </div>
      <div style="top:0; right: 0;width: 32.5%;">
        <div data-animation="slideInDown" data-animation-delay=".3s"
          class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
          style="background-color: #FAFAFA !important;">
          <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
            <div class="d-flex align-items-center justify-content-md-start justify-content-center">
              <img src="./assets/service5.svg" alt="Research" class="img-fluid" />
            </div>
            <h6 class="dark-black fw-medium text-md-start text-center">
          ...
          <div class="d-flex flex-column gap-3 p-md-4 p-3">
            <p class="brown lh-lg text-md-start text-center">
              Leverage the power of data analysis and data modeling techniques to optimize your business decisions with
              actionable insights reports and predictive models. With data visualization, transform complex data into
              compelling visual representations facilitating easy
            </p>
            <p class="cardDetails brown" style="margin-top: -15px !important;"> 
        ...
        <div data-animation="slideInDown" data-animation-delay=".3s"
          ...
          <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
            <div class="d-flex align-items-center justify-content-md-start justify-content-center">
              <img src="./assets/service6.svg" alt="Research" class="img-fluid" />
            </div>
            <h6 class="dark-black fw-medium text-md-start text-center">
              API Documentation
            </h6>
          ...
          <div class="d-flex flex-column gap-3 p-md-4 p-3">
            <p class="brown lh-lg text-md-start text-center">
              Facilitate API integration and API adoption process for your clients through our detailed API reference
              documents and illustrative sample requests and responses. Moreover, a clear and comprehensive
              error-handling procedure section addresses any issues that
            </p>
            <p class="cardDetails brown" style="margin-top: -15px !important;">  may arise
              swiftly. </p>
    ...
    <div class="cd-sec" style="position: relative; display: flex;padding-top: 0px !important;margin-top: -30px !important;">
      <div style="top: 0;left: 0;width: 32.5%;">
        <div data-animation="slideInDown" data-animation-delay=".3s"
          class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
          style="background-color: #FAFAFA !important;">
  ...
  <!-- <div class="cards serviceCards row d-flex justify-content-center gap-3">
      <div data-animation="slideInDown" data-animation-delay=".3s"
        class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
        style="background-color: #FAFAFA !important;">
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-md-start justify-content-center">
            <img src="./assets/service1.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-md-start text-center">
            Business Process Modeling
          </h6>
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Revolutionize your business operations with our dynamic business process modeling service. We provide
            easy-to-understand process flowcharts, detailed business process models, and practical optimization
            recommendations to enhance your workflows.
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2"> Process Flows</li>
            <li class="mt-2">Swimlanes</li>
            <li class="mt-2">System Sequence Diagrams</li>
            <li class="mt-2">Activity Sequence Diagrams</li>
            <li class="mt-2">Process Level Data Flow Diagrams</li>
            <li class="mt-2">Use Case Diagrams</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Boost your business strategies with our data-driven reports uncover valuable insights and spot emerging
            trends. Furthermore, we specialize in identifying expansion opportunities by optimizing your operations and
            enhancing overall productivity.
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Business Analysis Planning and Monitoring</li>
            <li class="mt-2">Business Analysis Reports</li>
            <li class="mt-2">Gap Analysis</li>
            <li class="mt-2">Cost-Benefit Analysis Report</li>
            <li class="mt-2">SWOT Analysis</li>
            <li class="mt-2">Competitor analysis and benchmarking</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Empower your software projects with our proven project management expertise facilitating efficient
            execution, superior quality, and transparent progress tracking. You’ll stay updated with project status
            reports, and resource allocation plans, and benefit from comprehensive testing reports
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Risk management</li>
            <li class="mt-2">Quality Assurance and Control</li>
            <li class="mt-2">Resource Allocation</li>
            <li class="mt-2">Stakeholder Communication</li>
            <li class="mt-2">Feasibility Study Document</li>
            <li class="mt-2">Change Management</li>
            <li class="mt-2">Team Collaboration and Client Reporting</li>
          </ul>
        </div>
      </div>
      <div class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
        style="background-color: #FAFAFA !important;">
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-lg-start justify-content-center">
            <img src="./assets/service4.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-lg-start text-center">
            Software Documentation
          </h6>
        </div>
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-lg-start text-center">
            Elevate software understanding, with our user-centric guides, that minimize learning curves and maximize
            proficiency. Our troubleshooting manuals simplify support processes, ensuring efficient issue resolution and
            version release notes keep users informed.
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Software Requirements Document</li>
            <li class="mt-2">Business Requirements Document</li>
            <li class="mt-2">Product Requirements Document</li>
            <li class="mt-2">Functional Specification Document</li>
            <li class="mt-2">Elicitation and Collaboration Document</li>
            <li class="mt-2">Solution Evaluation Document</li>
          </ul>
        </div>
      </div>
      <div class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-lg-start text-center">
            Leverage the power of data analysis and data modeling techniques to optimize your business decisions with
            actionable insights reports and predictive models. With data visualization, transform complex data into
            compelling visual representations facilitating easy understanding and interpretation.
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Data Collection and Cleaning</li>
            <li class="mt-2">Exploratory Data Analysis (EDA)</li>
            <li class="mt-2">Data Visualization</li>
            <li class="mt-2">Predictive Modelling</li>
            <li class="mt-2">Statistical Modelling</li>
            <li class="mt-2">Data Simulation</li>
          </ul>
        </div>
      </div>
      <div class="card serviceCardsContainers d-flex flex-column align-items-lg-start align-items-center"
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-lg-start text-center">
            Facilitate API integration and API adoption process for your clients through our detailed API reference
            documents and illustrative sample requests and responses. Moreover, a clear and comprehensive error-handling
            procedure section addresses any issues that may arise swiftly.
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">API Documentation</li>
            <li class="mt-2">Client Onboarding Document</li>
            <li class="mt-2">Core Document</li>
            <li class="mt-2">Troubleshooting Manuals</li>
            <li class="mt-2">Integration Plan Document</li>
            <li class="mt-2">Architecture Document</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-md-start justify-content-center">
            <img src="./assets/service7.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-md-start text-center">
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Our user-centric software product analysis involves usability testing reports that pave the way to a
            user-friendly product, while feature usage analytics empower you to optimize the software's functionality.
            Whereas, the comparative analysis reports help identify the product’s strengths and distinctive features,
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Requirements Analysis Report</li>
            <li class="mt-2">Risk Analysis and Mitigation Document</li>
            <li class="mt-2">System Analysis Report</li>
            <li class="mt-2">Discovery Reports</li>
            <li class="mt-2">Research Reports</li>
            <li class="mt-2">Feasibility Study Document</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-md-start justify-content-center">
            <img src="./assets/service8.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-md-start text-center">
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Access real-time KPI dashboards for immediate insights into your critical performance metrics. Explore
            historical performance trend analysis identifying patterns and deviations, and receive actionable
            recommendations to enhance your key metrics,
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">KPI Identification and Definition</li>
            <li class="mt-2">Data Collection and Aggregation</li>
            <li class="mt-2">Performance Dashboards</li>
            <li class="mt-2">Root Cause Analysis</li>
            <li class="mt-2">Benchmarking Reports</li>
            <li class="mt-2">Trend Analysis</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-md-start justify-content-center">
            <img src="./assets/service9.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-md-start text-center">
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Leverage market research findings, to get detailed analysis of user demands and preferences, and prototype
            feedback to drive informed adjustments. Our viability assessments further evaluate market fit, scalability,
            and revenue potential, ensuring the product's viability.
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Market Surveys and Polls</li>
            <li class="mt-2">Focus Group Discussions</li>
            <li class="mt-2">Software Process Automation</li>
            <li class="mt-2">User Personas</li>
            <li class="mt-2">Competitor Analysis</li>
            <li class="mt-2">Expert Analysis and Reviews</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-md-start justify-content-center">
            <img src="./assets/service10.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-md-start text-center">
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Our published research papers offer an industry knowledge base to stay at the forefront while the prototypes
            and proof of concept validate research's viability, setting the stage for further development. Lastly, the
            innovative feature proposals boost software competitiveness with our latest research insights
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Project Development Plan</li>
            <li class="mt-2">Feature and Functional Specification Document</li>
            <li class="mt-2">Requirements Control Plan</li>
            <li class="mt-2">Time Estimation Plan</li>
            <li class="mt-2">Cost Estimation Plan</li>
            <li class="mt-2">Change Management Plan</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-md-start justify-content-center">
            <img src="./assets/service11.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-md-start text-center">
            UX and Wireframing
          </h6>
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            Our interactive wireframes offer interactive elements and user flows, guiding user navigation, while user
            journey maps visually represent interactions to enhance overall experiences. Additionally, our design
            recommendations include expert suggestions and rationale to enhance user engagement and satisfaction
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">User Journey mapping</li>
            <li class="mt-2">Low Fidelity Wireframes</li>
            <li class="mt-2">Prototyping</li>
            <li class="mt-2">User Flow Optimization</li>
            <li class="mt-2">Visual Design Mockups</li>
            <li class="mt-2">Heuristic Evaluation</li>
          </ul>
        </div>
      </div>
      <div data-animation="slideInDown" data-animation-delay=".3s"
        ...
        <div class="d-flex gap-2 flex-column serviceCardColor w-100 p-md-4 p-3">
          <div class="d-flex align-items-center justify-content-md-start justify-content-center">
            <img src="./assets/service12.svg" alt="Research" class="img-fluid" />
          </div>
          <h6 class="dark-black fw-medium text-md-start text-center">
        ...
        <div class="d-flex flex-column gap-3 p-md-4 p-3">
          <p class="brown lh-lg text-md-start text-center">
            You will experience clear insights through our detailed architecture diagrams, while our scalability and
            performance analysis ensure your software operates at its peak under increased loads. Furthermore, our
            security architecture documents specify protocols, encryption, and access controls, fortifying your software
            against threat.
          </p>
          <ul class="ms-5 brown cardDetails">
            <li class="mt-2">Architecture Diagram</li>
            <li class="mt-2">Sitemaps and Screen flows</li>
            <li class="mt-2">Process Flow and Data Flow Diagrams</li>
            <li class="mt-2">Class and Entity Relationship Diagrams</li>
            <li class="mt-2">Design Definitions</li>
            <li class="mt-2">Work Breakdown Structure</li>
          </ul>
        </div>
      </div>
    </div> -->
        ...
        <h1 class="dark-black text-lg-start text-center fw-bold">
          ...
          <div class=" order-md-1 order-2 d-flex flex-column gap-3 flex-grow-1 flex-shrink-0 flex-basis-0 ">
                ...
                <div class="brown pe-lg-5 text-md-start partner-ticks">
                  <p>ISO 9001, a quality management standard, outlines general principles for quality management systems, applicable to various business processes, including business analysis. </p>
                </div>
              </div>
              ...
              <div class="d-flex gap-2 align-items-start ">
                <img src="{{asset('assets/tick.svg')}}" alt="tick" class=" d-md-block">
              <div class="brown pe-lg-5 text-md-start partner-ticks">
                <p>Adherence to project management standards like PMBOK (Project Management Body of Knowledge) ensures effective project planning, execution, and control.</p>
              </div>
            </div>
            <div class="d-flex gap-2 align-items-start ">
              <img src="{{asset('assets/tick.svg')}}" alt="tick" class=" d-md-block">
            <div class="brown pe-lg-5 text-md-start partner-ticks">
              <p>Following best practices in software development, such as those outlined by the Software Engineering Institute's Capability Maturity Model Integration (CMMI), helps ensure high-quality software.</p>
            </div>
          </div>
          <div class="d-flex gap-2 align-items-start ">
            <img src="{{asset('assets/tick.svg')}}" alt="tick" class=" d-md-block">
          <div class="brown pe-lg-5 text-md-start partner-ticks">
            <p>Adherence to guidelines and standards set by organizations like the International Institute of Business Analysis (IIBA) ensures professionalism and consistency in business analysis practices.</p>
          </div>
  ...
  <div class="cardsSection d-flex flex-column justify-content-center align-items-center gap-3 howWork" style="
  background: #EFEFEF;
">
    <!-- ------------ABOUT US CONTENT SECTION---------------- -->
    <section id="animation-sec" style="width: 100%;">
      <!-- <div class="container"> -->
      <div style="background-color: linear-gradient(0deg, #0D3642, #0D3642),
      ...
      <div class="about-us-line" style="position: relative;">
        <div class="service-cli-col-cards">
          ...
          <div class="ser-col-card card1">
            <img src="{{asset('assets/cli-card-1.svg')}}" alt="cli-card-1">
            <h2 style="color: #232323;padding-top: 16px !important;">Requirement Gathering</h2>
            <p style="color: #5F5F5F;padding-top: 4px !important;">Delve deep into your business processes, objectives, and challenges. Our goal is to collect crucial data, establishing a solid foundation for a comprehensive analysis of your needs.</p>
          </div>
          <div class="ser-col-card card2" style="position: relative;">
            ...
            <img src="{{asset('assets/cli-card-2.svg')}}" alt="cli-card-1">
            <h2 style="color: #232323;padding-top: 16px !important;">Expert Consultation</h2>
            <p style="color: #5F5F5F;padding-top: 4px !important;"> Count on our team of experienced professional advisors for guidance and recommendations. Their expertise ensures a highly informed and strategic approach to your unique challenges.</p>
          </div>

          <div class="ser-col-card card3" style="position: relative;">
            <img src="{{asset('assets/cli-card-3.svg')}}" alt="cli-card-1">
            ...
            <p style="color: #5F5F5F;padding-top: 4px !important;">Building upon the insights gained through expert consultation, we conduct a careful analysis. This process results in solutions precisely coordinate to your business goals, offering a roadmap to success.</p>
          </div>
  ...
  <div
    ...
    <div
      ...
      <div class="button-wrap">
        <button style="margin-top: 0;" data-bs-toggle="modal" data-bs-target="#staticBackdrop" id="scrollToSection2"
          type="button"
          ...
          <div class="flex-column modal-content scrollable-modal-content partnerForm px-lg-5 px-md-4 px-3 py-5 gap-3">
            ...
            <form action="#" class="becomepartform text-start d-flex flex-column gap-xl-4 gap-3 w-100 ex-respon">
              ...
              <div class="flex-column gap-2 pos-rev" id="companyNameselect">
                ...
                <div class="position-relative">
                  <input style="color: #acacac;width: 100%;" type="text" id="companyName" name="company_name"
                    class="border-0" name="compan_name" placeholder="Enter Company Name" />
                </div>
              </div>
              <div class="flex-column gap-1 pos-rev" id="nameselect">
                ...
                <div class="position-relative">
                  <input style="color: #acacac; width: 100%;" type="text" id="Name" name="sponser_name" class="border-0"
              ...
              <div class="flex-column gap-2 pos-rev" id="repnameselect">
                ...
                <div class="position-relative">
                  <input style="color: #acacac;width: 100%;" type="text" id="representativeName" name="user_name"
                    class="border-0" placeholder="Spokesperson Name" />
                </div>
              </div>
              <script>
              ...
              <div
               ...
               window.iti = iti;
                ...
                <div class="w-100 d-flex flex-column gap-2">
                  ...
                  <div class="position-relative">
                    <input type="email" style="color: #acacac; width: 100%;" id="Email" name="email" class="border-0"
              ...
              <div class="row justify-content-center w-100 secondDiv" id="div3"
                ...
                <div
                  ...
                  <form action="#" id="bookconsultform" class="w-100 d-flex align-items-start flex-column gap-3">
                    <div class="d-flex flex-column gap-1 w-100 pos-rev">
                      ...
                      <input type="text" name="name" id="name" class="form-control p-2" placeholder="Enter Name" style="
                ...
                <div class="col-lg-4 col-12 d-flex flex-column p-4 gap-lg-5" style="background-color: #0d3642">
                  <div class="d-flex justify-content-end align-items-center"
                    ...
                    <svg data-bs-dismiss="modal" style="cursor: pointer" xmlns="http://www.w3.org/2000/svg" width="27"
