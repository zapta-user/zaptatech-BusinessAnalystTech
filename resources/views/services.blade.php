            ...
            <div class="about-us-line" style="position: relative;">
                <div class="service-cli-col-cards">
                    ...
                    <div class="ser-col-card card1">
                        <img src="{{ asset('assets/sync4tech-business-process-step-01-comprehensive-business-analysis.svg') }}" alt="Sync4Tech Business Process Step 1- requirement gathering">
                    ...
                    <div class="ser-col-card card2" style="position: relative;">
                        ...
                        <img src="{{ asset('assets/sync4tech-business-process-step-02-expert-consultation.svg') }}" alt="Sync4Tech Business Process Step 2 - expert consultation">
                    ...
                    <div class="ser-col-card card3" style="position: relative;">
                        <img src="{{ asset('assets/sync4tech-business-process-step-03-expert-consultation.svg') }}" alt="Sync4Tech Business Process Step 3 - comprehensive business analysis">
