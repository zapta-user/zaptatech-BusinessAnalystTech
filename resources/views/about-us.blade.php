...
<head>
  ...
  <title>About Us | Sync4Tech</title>
...
<body>
    ...
    <div class="container-fluid px-xl-5 px-0">
      ...
      <div class="collapse navbar-collapse mt-lg-2 mt-4" id="navbarNavDropdown">
        <ul class="navbar-nav ms-xl-auto m-lg-auto gap-xl-4 gap-lg-0 gap-2">
          ...
          <li class="nav-item">
            <a class="nav-link mx-2 link-color pb-2 active" href="{{route('frontend.aboutUs')}}">About Us</a>
          </li>
          <li class="nav-item">
      ...
      <div class="d-flex justify-content-lg-between flex-wrap justify-content-center gap-2">
        <div class="col-xl-6 col-lg-6 col-md-6 expertContent d-flex flex-column gap-lg-3 gap-2">
          ...
          <p class="content-color text-md-start text-center px-md-0 px-sm-5 mt-0">
            Navigating the intricacies of business analysis, process improvement, and data analysis, our collaborative spirit ensures that your unique needs are not only met but exceeded. Integrity, client-centricity are not abstract concepts but the pillars upon which we build partnerships.From software business analysis to business process reengineering, we cover the spectrum of your needs.
          </p>
          <p class="content-color text-md-start text-center px-md-0 px-sm-5 mt-0">
            At Sync4Tech, our mission is clear – to be your trusted and value-driven software development partner.
            Explore the Sync4Tech difference – where value meets innovation, and success becomes a shared journey. Your business evolution starts here.
          </p>
        </div>
  ...
  <!-- <section id="expertSectiongap">
    <div class="container">
      
    </div>
    <div class="cardsSection row d-flex justify-content-center justify-content-lg-around align-items-center">
      ...
      <div class="about-us-line" style="position: relative;">
        <div class="service-cli-col-cards">
          ...
          <div class="ser-col-card card1">
            <img loading="lazy" width="100" height="100" src="{{asset('assets/business-step1.svg')}}" alt="cli-card-1">
            <h2 style="color: #FFFFFF;padding-top: 16px !important;">Requirement Gathering</h2>
            <p style="color: #C1C1C1;padding-top: 4px !important;">Delve deep into your business processes, objectives, and challenges. Our goal is to collect crucial data, establishing a solid foundation for a comprehensive analysis of your needs.</p>
          </div>
          <div class="ser-col-card card2" style="position: relative;">
            <img  loading="lazy" width="100" height="100" src="{{asset('assets/business-step2.svg')}}" alt="cli-card-1">
            <h2 style="color: #FFFFFF;padding-top: 16px !important;">Expert Consultation</h2>
            <p style="color: #C1C1C1;padding-top: 4px !important;">Count on our team of experienced professional advisors for guidance and recommendations. Their expertise ensures a highly informed and strategic approach to your unique challenges.</p>
          </div>

          <div class="ser-col-card card3" style="position: relative;">
            <img  loading="lazy" width="100" height="100" src="{{asset('assets/business-step3.svg')}}" alt="cli-card-1">
           
            <h2 style="color: #FFFFFF;padding-top: 16px !important;">Comprehensive Business Analysis</h2>
            <p style="color: #C1C1C1;padding-top: 4px !important;">Building upon the insights gained through expert consultation, we conduct a careful analysis. This process results in solutions precisely coordinate to your business goals, offering a roadmap to success.</p>
          </div>
  ...
  <div class="w-100 cardsSection row d-flex justify-content-center justify-content-lg-around align-items-center"
    ...
    <div class="col-lg-4 col-md-5 col-12 d-flex justify-content-center align-items-center">
      <img loading="lazy" width="500" height="552" src="{{asset('assets/ceo2.webp')}}" alt="CEO" class="img-fluid" />
    </div>
    <div class="col-lg-6 col-md-6 expertContent d-flex flex-column gap-1">
      ...
      <p class="content-color text-md-start px-lg-0 px-md-3">
        As we step into a new era, I want to emphasize our commitment to innovation, collaboration, and excellence. Our
      ...
      font-size: 18px; font-weight: 500;" class="content-color text-md-start px-lg-0 m-0">Let’s focus on:</p>
  ...
  <div
    ...
    <div
      class="d-flex w-100 flex-md-row flex-column mt-0 gap-lg-3 gap-2 justify-content-center align-items-center">
            ...
            <div class="modal-content book-modal-content firstDivModal">
              ...
              <div class="row justify-content-center w-100 secondDiv" id="div3"
                ...
                <div
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="position-absolute" style="cursor: pointer;top:30px;" width="32" 
